...
namespace PE {
    ...
    void EffectManager::loadDefaultEffects()
    {
		...
		PEINFO("PE: PROGRESS: Creating m_firstPassTextureGPU\n");
		// need magnification filtering since we render this small texture onto larger result RT
		m_firstPassTextureGPU.createDrawableIntoColorTexture(m_pContext->getGPUScreen()->getWidth(), m_pContext->getGPUScreen()->getHeight(), SamplerState_NoMips_NoMinTexelLerp_MagTexelLerp_Clamp);
...
#	endif
...

	{
		...
		pEffect->loadTechnique(
			"ColoredMinimalMesh_VS", "main",
			NULL, NULL, // geometry shader
			"ColoredMinimalMesh_OneTexture_PS", "main",
			NULL, NULL, // compute shader
			PERasterizerState_SolidTriBackCull,
		...
		m_map.add("ColoredMinimalMesh_OneTexture_Tech", hEffect);
	}
...
#pragma region Fluid
	...
	// advection
	{
		...
		pEffect->loadTechnique(
			...
			NULL, NULL, // geometry shader
			NULL, NULL,
			"Fluid_Advection_CS", "main", // compute shader
			PERasterizerState_SolidTriBackCull,
			PEDepthStencilState_ZBuffer, PEAlphaBlendState_NoBlend, // depth stencil, blend states
			"Fluid_Advection_CS_Tech");

		pEffect->m_psInputFamily = EffectPSInputFamily::DETAILED_MESH_PS_IN;
		m_map.add("Fluid_Advection_CS_Tech", hEffect);
	}
	...
	// solver
	{
		...
		pEffect->loadTechnique(
			...
			NULL, NULL, // geometry shader
			NULL, NULL,
			"Fluid_Solver_CS", "main", // compute shader
			PERasterizerState_SolidTriBackCull,
			PEDepthStencilState_ZBuffer, PEAlphaBlendState_NoBlend, // depth stencil, blend states
			"Fluid_Solver_CS_Tech");

		pEffect->m_psInputFamily = EffectPSInputFamily::DETAILED_MESH_PS_IN;
		m_map.add("Fluid_Solver_CS_Tech", hEffect);
	}
	...
	// solver velocity
	{
		...
		pEffect->loadTechnique(
			...
			NULL, NULL, // geometry shader
			NULL, NULL,
			"Fluid_Solver_Velocity_CS", "main", // compute shader
			PERasterizerState_SolidTriBackCull,
			PEDepthStencilState_ZBuffer, PEAlphaBlendState_NoBlend, // depth stencil, blend states
			"Fluid_Solver_Velocity_CS_Tech");

		pEffect->m_psInputFamily = EffectPSInputFamily::DETAILED_MESH_PS_IN;
		m_map.add("Fluid_Solver_Velocity_CS_Tech", hEffect);
	}
	...
	// divergence
	{
		...
		pEffect->loadTechnique(
			...
			NULL, NULL, // geometry shader
			NULL, NULL,
			"Fluid_Divergence_CS", "main", // compute shader
			PERasterizerState_SolidTriBackCull,
			PEDepthStencilState_ZBuffer, PEAlphaBlendState_NoBlend, // depth stencil, blend states
			"Fluid_Divergence_CS_Tech");

		pEffect->m_psInputFamily = EffectPSInputFamily::DETAILED_MESH_PS_IN;
		m_map.add("Fluid_Divergence_CS_Tech", hEffect);
	}
	...
	// divergence free
	{
		...
		pEffect->loadTechnique(
			...
			NULL, NULL, // geometry shader
			NULL, NULL,
			"Fluid_DivergenceFree_CS", "main", // compute shader
			PERasterizerState_SolidTriBackCull,
			PEDepthStencilState_ZBuffer, PEAlphaBlendState_NoBlend, // depth stencil, blend states
			"Fluid_DivergenceFree_CS_Tech");

		pEffect->m_psInputFamily = EffectPSInputFamily::DETAILED_MESH_PS_IN;
		m_map.add("Fluid_DivergenceFree_CS_Tech", hEffect);
	}
	...
	// boundary
	{
		...
		pEffect->loadTechnique(
			...
			NULL, NULL, // geometry shader
			NULL, NULL,
			"Fluid_Boundary_CS", "main", // compute shader
			PERasterizerState_SolidTriBackCull,
			PEDepthStencilState_ZBuffer, PEAlphaBlendState_NoBlend, // depth stencil, blend states
			"Fluid_Boundary_CS_Tech");

		pEffect->m_psInputFamily = EffectPSInputFamily::DETAILED_MESH_PS_IN;
		m_map.add("Fluid_Boundary_CS_Tech", hEffect);
	}
	...
	// external force
	{
		...
		pEffect->loadTechnique(
			...
			NULL, NULL, // geometry shader
			NULL, NULL,
			"Fluid_ExternalForce_CS", "main", // compute shader
			PERasterizerState_SolidTriBackCull,
			PEDepthStencilState_ZBuffer, PEAlphaBlendState_NoBlend, // depth stencil, blend states
			"Fluid_ExternalForce_CS_Tech");

		pEffect->m_psInputFamily = EffectPSInputFamily::DETAILED_MESH_PS_IN;
		m_map.add("Fluid_ExternalForce_CS_Tech", hEffect);
	}
	...
	// full screen
	{
		...
		pglowseparationpassfx->loadTechnique(
			"ColoredMinimalMesh_2D_VS", "main",
			NULL, NULL, // geometry shader
			"Fluid_FullScreen_PS", "main",
			NULL, NULL, // compute shader
			PERasterizerState_SolidTriNoCull,
			PEDepthStencilState_NoZBuffer, PEAlphaBlendState_NoBlend, // depth stencil, blend states
			"Fluid_FullScreen_PS_Tech");
		pglowseparationpassfx->m_psInputFamily = EffectPSInputFamily::REDUCED_MESH_PS_IN;
		m_map.add("Fluid_FullScreen_PS_Tech", hglowseparationpassfx);
	}
	...
	// Surface
	{
		...
		pglowseparationpassfx->loadTechnique(
			"DetailedMesh_FluidSurface_VS", "main",
			NULL, NULL, // geometry shader
			"DetailedMesh_FluidSurface_PS", "main",
			NULL, NULL, // compute shader
			PERasterizerState_SolidTriNoCull,
			PEDepthStencilState_ZBufferNoWrite, PEAlphaBlendState_DefaultRGBLerp_A_DestUnchanged, // depth stencil, blend states
			"Fluid_Surface_Tech");
		pglowseparationpassfx->m_psInputFamily = EffectPSInputFamily::REDUCED_MESH_PS_IN;
		pglowseparationpassfx->m_effectDrawOrder = EffectDrawOrder::Last;
		m_map.add("Fluid_Surface_Tech", hglowseparationpassfx);
	}
...
#pragma endregion
	...
	// copy buffer
	{
		...
		pEffect->loadTechnique(
			...
			NULL, NULL, // geometry shader
			NULL, NULL,
			"CopyBuffer_CS", "main", // compute shader
			PERasterizerState_SolidTriBackCull,
			PEDepthStencilState_ZBuffer, PEAlphaBlendState_NoBlend, // depth stencil, blend states
			"CopyBuffer_CS_Tech");

		pEffect->m_psInputFamily = EffectPSInputFamily::DETAILED_MESH_PS_IN;
		m_map.add("CopyBuffer_CS_Tech", hEffect);
	}
	...
	// copy texture
	{
		...
		pEffect->loadTechnique(
			...
			NULL, NULL, // geometry shader
			NULL, NULL,
			"CopyTexture_CS", "main", // compute shader
			PERasterizerState_SolidTriBackCull,
			PEDepthStencilState_ZBuffer, PEAlphaBlendState_NoBlend, // depth stencil, blend states
			"CopyTexture_CS_Tech");

		pEffect->m_psInputFamily = EffectPSInputFamily::DETAILED_MESH_PS_IN;
		m_map.add("CopyTexture_CS_Tech", hEffect);
	}
	...
	// clear buffer
	{
		...
		pEffect->loadTechnique(
			...
			NULL, NULL, // geometry shader
			NULL, NULL,
			"ClearBuffer_CS", "main", // compute shader
			PERasterizerState_SolidTriBackCull,
			PEDepthStencilState_ZBuffer, PEAlphaBlendState_NoBlend, // depth stencil, blend states
			"ClearBuffer_CS_Tech");

		pEffect->m_psInputFamily = EffectPSInputFamily::DETAILED_MESH_PS_IN;
		m_map.add("ClearBuffer_CS_Tech", hEffect);
	}
