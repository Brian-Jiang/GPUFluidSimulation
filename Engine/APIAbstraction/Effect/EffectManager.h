...
struct EffectManager : public PE::PEAllocatableAndDefragmentable
{
    ...
    void bindFirstPassRTAsSampler(Handle hEffect, EGpuResourceSlot slot);
    void unbindFirstPassRTAsSampler(Handle hEffect);
...
public:
	...
	TextureGPU m_firstPassTextureGPU;
...
#	endif
	...
	PE::SA_Bind_Resource* setFirstPassTextureAction;
