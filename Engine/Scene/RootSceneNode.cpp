...
void RootSceneNode::do_GATHER_DRAWCALLS(Events::Event *pEvt)
{
	...
	if (setGlobalValues)
	{
        ...
        p->m_data.gScreenWidth1 = m_pContext->getGPUScreen()->getWidth();
        p->m_data.gScreenHeight1 = m_pContext->getGPUScreen()->getHeight();
		//p;
		//int i = 0;
		//++i;
		//p->m_data.gScreenHeight1 = i;
	}
	...
	if (setGlobalValues)
	{
		...
		psvPerObjectGroup->m_data.gViewProjInverseMatrix = psvPerObjectGroup->m_data.gViewProj.inverse();
