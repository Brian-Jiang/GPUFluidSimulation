...
ID3D11Buffer * SetFluidConstantsShaderAction::s_pBuffer = NULL;
ID3D11Buffer * SetFluidForcesShaderAction::s_pBuffer = NULL;
ID3D11ShaderResourceView* SetFluidForcesShaderAction::s_pSRV = NULL;
